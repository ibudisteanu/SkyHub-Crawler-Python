    ...
    def processScrapedData(self, url):
        ...
        if validation in ['news', 'topic']:
            ...
            if LinksDB.findLinkObjectAlready(self.domain, url) is None:
                topicObject = LinksDB.findLinkObjectAlready(self.domain, self.currentPageURL,
                ...
                if topicObject is not None:
                    ...
                    if len(self.replies) > 0:
                        for reply in self.replies:
                            ...
                            replyObject = LinksDB.findLinkObjectAlready(self.domain, replyObjectURL, replyObjectTitle,
                                                                        True)
